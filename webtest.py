...
driver.find_element(By.XPATH,"//*[@id=\"login-from-box\"]/form/div[1]/div/div/input").send_keys(username)
driver.find_element(By.XPATH,"//*[@id=\"login-from-box\"]/form/div[2]/div/div/input").send_keys(passwd)

#验证码
# 验证码输入框元素
codeElement = driver.find_element(By.XPATH, "//*[@id=\"login-from-box\"]/form/div[3]/div/div[1]/input")
# 验证图片元素
imgElement = driver.find_element(By.XPATH, "//*[@id=\"login-from-box\"]/form/div[3]/div/div[2]/img")
